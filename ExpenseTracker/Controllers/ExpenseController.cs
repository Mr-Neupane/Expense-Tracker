        ...
        using (NpgsqlConnection conn = (NpgsqlConnection)DapperConnectionProvider.GetConnection())
        {
            using (var txn = conn.BeginTransaction())
            {
                try
                {
                    ...
                    {
                        _toastNotification.AddErrorToastMessage("Insufficient balance on selected Ledger");
                    ...
                    _toastNotification.AddSuccessToastMessage("Expense record successfully created");
